...
var HelpText = /*#__PURE__*/ (function (_Component) {
  ...
  function HelpText(props) {
    ...
    _this.debouncedApplyStyleToCurrentNode = lodash_debounce(
      _this.applyStyleToCurrentNode.bind(_assertThisInitialized(_this)),
      10
    );
    _this.mask = createElement(
      "div",
      "userGuide--mask ".concat(styles.userGuideMask)
    );
    return _this;
  }
  ...
  _createClass(HelpText, [
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps) {
        ...
        console.log(
          "component updated",
          prevProps.specificHelpIndex,
          this.props.specificHelpIndex
        );
      },
    },
    {
    ...
    },
    {
      ...
      value: function removeResizeListener() {
        win.removeEventListener(
          "resize",
          this.debouncedApplyStyleToCurrentNode
        );
      },
    },
    {
      ...
      value: function getNode() {
        console.log(
          "this is the specific help index getNnode Key",
          this.props.specificHelpIndex
        );
        var _this$props = this.props,
          ...
          onSpecificGuide = _this$props.onSpecificGuide;
        ...
        onSkipCallback = _this$props.onSkipCallback;
        specificHelpIndex = _this$props.specificHelpIndex;
        var node = createElement(
          "span",
          "userGuide--message "
            .concat(styles.userGuideMessage, " ")
            .concat(styles["userGuideMessage".concat(position)]),
          ""
        );
        var titleEl = createElement("h3", styles.userGuideMessageTitle, title);
        var messageEl = createElement(
          "p",
          styles.userGuideMessageBody,
          message
        );
        ...
        nextButton.addEventListener("click", () => {
          ...
          console.log("this is the specific help index...", specificHelpIndex);
          onNext();
          // onSpecificGuide(specificHelpIndex)
        });
          ...
          switch (position) {
            case "east":
              this.node = applyStyle(this.node, {
                left: "".concat(
                  nodeMargin + helpNeededElLeft + helpNeededElWidth,
                  "px"
                ),
                top: "".concat(
            ...
            case "west":
              this.node = applyStyle(this.node, {
                left: "".concat(
                  helpNeededElLeft - nodeWidth - nodeMargin,
                  "px"
                ),
                top: "".concat(
                  helpNeededElTop + (helpNeededElHeight / 2 - nodeHeight / 2),
            ...
            case "south":
              this.node = applyStyle(this.node, {
                ...
                top: "".concat(
                  helpNeededElTop + helpNeededElHeight + nodeMargin,
                  "px"
                ),
              });
              break;
...
var UserGuide = /*#__PURE__*/ (function (_Component2) {
  ...
  function UserGuide(props) {
    ...
    _this2.state = {
      helpIndex: props.specificHelpIndex,
      acceptedConfirm: false,
    };

    _this2.userGuideDisabledFromBegenning = !!win.localStorage.getItem(
      "userGuide-".concat(props.guideKey)
    );
    ...
    _this2.acceptConfirm = _this2.acceptConfirm.bind(
      _assertThisInitialized(_this2)
    );
    _this2.onSpecificGuide = _this2.onSpecificGuide.bind(
      _assertThisInitialized(_this2)
    );
    return _this2;
  }
  ...
  _createClass(UserGuide, [
    ...
    },
    {
      ...
      value: function onNext() {
        ...
        //   });
        // }
        console.log(guides.length, "guides length");
        this.setState({
          helpIndex: guides.length,
        });
      },
    ...
    {
      key: "onSpecificGuide",
      value: function onSpecificGuide(specificHelpIndex) {
        // var guides = this.props.guides;
        var newHelpIndex = specificHelpIndex;
      ...
      value: function render() {
        ...
        return /*#__PURE__*/ React__default["default"].createElement(
          ...
          _extends({}, helpConfig, {
            ...
            onNext: this.onNext,
            onSpecificGuide: this.onSpecificGuide,
            onSkip: this.onSkip,
            isLast: isLast,
            specificHelpIndex: specificHelpIndex,
          }),
          children || ""
        );
      },
  ...
  _createClass(UserGuide, null, [
    {
      key: "getDerivedStateFromProps",
      value: function getDerivedStateFromProps(props, state) {
        if (props.userGuidingState && props.specificHelpIndex !== undefined) {
          return {
            helpIndex: props.specificHelpIndex,
            acceptConfirm: false,
          };
