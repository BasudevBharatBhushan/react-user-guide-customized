...
var PropTypes = require$$1__default["default"];
...
var HelpText = /*#__PURE__*/function (_Component) {
  ...
  _createClass(HelpText, [{
    ...
    value: function componentDidUpdate(prevProps) {
      this.showHelp();
      console.log("component updated", prevProps.specificHelpIndex, this.props.specificHelpIndex);
    }
  }, {
    ...
    value: function getNode() {
      console.log("this is the specific help index getNnode Key", this.props.specificHelpIndex);
      var _this$props = this.props,
        title = _this$props.title,
        message = _this$props.message,
        onNext = _this$props.onNext;
        _this$props.onSpecificGuide;
      onSkip = _this$props.onSkip, position = _this$props.position, tooltipWidth = _this$props.tooltipWidth, isLast = _this$props.isLast, nextText = _this$props.nextText, skipText = _this$props.skipText, finishText = _this$props.finishText;
...
var UserGuide = /*#__PURE__*/function (_Component2) {
  ...
  function UserGuide(props) {
    ...
    _this2.onSpecificGuide = _this2.onSpecificGuide.bind(_assertThisInitialized(_this2));
    return _this2;
  }
  _createClass(UserGuide, [{
    ...
    value: function render() {
      ...
      console.log("User Guiding Triggered ...", userGuidingState, " help-index", helpIndex);
      if (!userGuidingState) {
        return children || "";
      }
